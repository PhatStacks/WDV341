...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        ...
        <li>
          <a class="gitgrey d-sm-block d-lg-none d-xl-none" href="https://github.com/PhatStacks/wdv341"><i class="fab fa-2x fa-github"></i></a>
        </li>
      </ul>
    </div>
    <a class="gitgrey hidesmall d-sm-none d-xl-block" href="https://github.com/PhatStacks/wdv341"><i class="fab fa-2x fa-github"></i></a>
  </nav>
...
<section class="violet">
  ...
  <form id="portfolioBioForm" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
    ...
    <h4>Team Members:</h4>
      <p>Spencer Davis, Almir Mujic, James Borlaug, and Phat Luong</p>
    </ul>
    <table>
    <tr>
    ...
    <tr>
    <td><input type="button" onclick="location.href='studentInfoForm.php'" value="Reset Bio"/></td>
    </tr>
    </table>
  </form>
  </div>
